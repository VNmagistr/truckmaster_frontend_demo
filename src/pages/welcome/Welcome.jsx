...
const WHY_US = [
  ...
  { icon: <CheckCircleOutlined />, title: 'Гарантія якості', desc: 'Надаємо гарантію на всі виконані роботи та встановлені запчастини' },
...
const FAQ_ITEMS = [
  {
    ...
    children: 'Виробник рекомендує ТО кожні 30 000 км або 1 раз на рік — залежно від умов експлуатації. Для важких умов (пил, короткі поїздки, гори) інтервал може бути скорочений. Наші майстри нададуть індивідуальну рекомендацію після діагностики.',
  },
  {
    key: '2',
    label: 'Чи є гарантія на виконані роботи?',
    children: 'Так. Ми надаємо гарантію на всі виконані роботи та встановлені запчастини. Термін гарантії залежить від типу роботи — уточнюйте у наших майстрів.',
  },
  {
    key: '3',
  ...
  },
  {
    ...
    children: 'Зателефонуйте або залиште заявку на сайті — ми безкоштовно проконсультуємо та нададемо орієнтовну вартість. Точна вартість визначається після діагностики.',
  },
  {
    key: '5',
      ...
      <section id="callback" style={{ padding: '96px 24px', background: 'linear-gradient(135deg, #0a1428 0%, #0f2547 100%)' }}>
        <div style={{ maxWidth: 560, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            ...
            <p style={{ color: '#94a3b8', fontSize: 16 }}>Заповніть форму — ми передзвонимо або напишемо в Telegram найближчим часом.</p>
          </div>
